...
public class EntityNetherArrow extends EntityArrow {
   ...
   public EntityNetherArrow(World worldIn, EntityLivingBase shooter, EntityLivingBase target, float velocity, float inaccuracy) {
      super(worldIn);
      this.renderDistanceWeight = 10.0D;
   ...
   public EntityNetherArrow(World worldIn, EntityLivingBase shooter, float velocity) {
      ...
      if (this.inGround) {
         ...
         if (movingobjectposition != null) {
            if (movingobjectposition.entityHit != null) {
               ...
               l = MathHelper.ceiling_double_int((double)f2 * this.damage);
               ...
               if (this.shootingEntity == null) {
                  damagesource = NetherDamageSource.causeArrowDamage(this, this);
               } else {
                  damagesource = NetherDamageSource.causeArrowDamage(this, this.shootingEntity);
               }
                  ...
                  if (movingobjectposition.entityHit instanceof EntityLivingBase) {
                     ...
                     if (!this.worldObj.isRemote) {
                        ...
                        case 2:
                           ...
                           if (f4 > 0.0F) {
                              movingobjectposition.entityHit.addVelocity(this.motionX * 1.5D * 0.6000000238418579D / (double)f4, 0.1D, this.motionZ * 1.5D * 0.6000000238418579D / (double)f4);
                           }
                           break;
                        case 3:
                           entitylivingbase.addPotionEffect(new PotionEffect(Potion.wither.id, 120));
                        }
                     }
   ...
   public void onCollideWithPlayer(EntityPlayer entityIn) {
      if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0) {
         ...
         if (this.canBePickedUp == 1 && !entityIn.inventory.addItemStackToInventory(new ItemStack(itemArrow, 1))) {
            flag = false;
         }
   ...
   public void setArrowType(int newType) {
      this.getDataWatcher().updateObject(12, (byte)newType);
   }
