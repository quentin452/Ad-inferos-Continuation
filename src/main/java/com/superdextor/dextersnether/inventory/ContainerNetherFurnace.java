...
public class ContainerNetherFurnace extends Container {
   private TileEntityNetherFurnace tileFurnace;
   private int lastCookTime;
   private int lastBurnTime;
   private int lastItemBurnTime;

   public ContainerNetherFurnace(InventoryPlayer p_i1812_1_, TileEntityNetherFurnace p_i1812_2_) {
   ...
   public void addCraftingToCrafters(ICrafting p_75132_1_) {
      ...
      p_75132_1_.sendProgressBarUpdate(this, 0, (int)this.tileFurnace.cookTime);
   ...
   public void detectAndSendChanges() {
      ...
      for(int i = 0; i < this.crafters.size(); ++i) {
         ...
         if ((float)this.lastCookTime != this.tileFurnace.cookTime) {
            icrafting.sendProgressBarUpdate(this, 0, (int)this.tileFurnace.cookTime);
         }
      ...
      this.lastCookTime = (int)this.tileFurnace.cookTime;
   ...
   public void updateProgressBar(int p_75137_1_, int p_75137_2_) {
      if (p_75137_1_ == 0) {
         this.tileFurnace.cookTime = (float)p_75137_2_;
      }
