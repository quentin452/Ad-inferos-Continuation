...
public class ModelSkeletonHorse extends ModelBase {
   ...
   public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
      EntitySkeletonHorse entityhorse = (EntitySkeletonHorse)p_78088_1_;
      int i = 3;
      float f6 = 0.0F;
      boolean flag = true;
      if (flag) {
   ...
   public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_) {
      ...
      EntitySkeletonHorse entityhorse = (EntitySkeletonHorse)p_78086_1_;
      float f8 = 0.0F;
      float f9 = entityhorse.mad;
      float f10 = 1.0F - f9;
      float f11 = 0.0F;
      boolean flag = false;
      boolean flag1 = false;
      ...
      float f13 = MathHelper.cos(p_78086_2_ * 0.6662F + 3.1415927F);
      ...
      this.head.rotateAngleY = f6 / 57.295776F;
      this.head.rotateAngleX = f9 * (0.2617994F + f7) + f8 * 2.18166F + (1.0F - Math.max(f9, f8)) * this.head.rotateAngleX;
      this.head.rotateAngleY = f9 * (f6 / 57.295776F) + (1.0F - Math.max(f9, f8)) * this.head.rotateAngleY;
      ...
      this.body.rotateAngleX = f9 * -0.7853982F + f10 * this.body.rotateAngleX;
      ...
      float f19 = MathHelper.cos(f12 * 0.6F + 3.1415927F);
      ...
      this.backLeftShin.rotationPointY = this.backLeftLeg.rotationPointY + MathHelper.sin(1.5707964F + f18 + f10 * -f13 * 0.5F * p_78086_3_) * 7.0F;
      this.backLeftShin.rotationPointZ = this.backLeftLeg.rotationPointZ + MathHelper.cos(4.712389F + f18 + f10 * -f13 * 0.5F * p_78086_3_) * 7.0F;
      this.backRightShin.rotationPointY = this.backRightLeg.rotationPointY + MathHelper.sin(1.5707964F + f18 + f10 * f13 * 0.5F * p_78086_3_) * 7.0F;
      this.backRightShin.rotationPointZ = this.backRightLeg.rotationPointZ + MathHelper.cos(4.712389F + f18 + f10 * f13 * 0.5F * p_78086_3_) * 7.0F;
      float f20 = (-1.0471976F + f19) * f9 + f14 * f10;
      float f21 = (-1.0471976F + -f19) * f9 + -f14 * f10;
      this.frontLeftShin.rotationPointY = this.frontLeftLeg.rotationPointY + MathHelper.sin(1.5707964F + f20) * 7.0F;
      this.frontLeftShin.rotationPointZ = this.frontLeftLeg.rotationPointZ + MathHelper.cos(4.712389F + f20) * 7.0F;
      this.frontRightShin.rotationPointY = this.frontRightLeg.rotationPointY + MathHelper.sin(1.5707964F + f21) * 7.0F;
      this.frontRightShin.rotationPointZ = this.frontRightLeg.rotationPointZ + MathHelper.cos(4.712389F + f21) * 7.0F;
      ...
      this.frontLeftShin.rotateAngleX = (this.frontLeftLeg.rotateAngleX + 3.1415927F * Math.max(0.0F, 0.2F + f19 * 0.2F)) * f9 + (f14 + Math.max(0.0F, f13 * 0.5F * p_78086_3_)) * f10;
      this.frontLeftHoof.rotateAngleX = this.frontLeftShin.rotateAngleX;
      this.frontRightLeg.rotateAngleX = f21;
      this.frontRightShin.rotateAngleX = (this.frontRightLeg.rotateAngleX + 3.1415927F * Math.max(0.0F, 0.2F - f19 * 0.2F)) * f9 + (-f14 + Math.max(0.0F, -f13 * 0.5F * p_78086_3_)) * f10;
