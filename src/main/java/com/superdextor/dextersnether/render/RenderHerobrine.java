...
public class RenderHerobrine extends RenderBiped {
   ...
   protected int shouldRenderPass(EntityHerobrine entity, int p_77032_2_, float p_77032_3_) {
      if (p_77032_2_ != 0) {
         return -1;
      } else {
   ...
   protected void renderModel(EntityLivingBase entity, float f1, float f2, float f3, float f4, float f5, float f6) {
      ...
      EntityHerobrine entityherobrine = (EntityHerobrine)entity;
      if (entityherobrine.InCloak()) {
         GL11.glPushMatrix();
   ...
   protected int shouldRenderPass(EntityLivingBase entity, int p_77032_2_, float p_77032_3_) {
      return this.shouldRenderPass((EntityHerobrine)entity, p_77032_2_, p_77032_3_);
   }

   protected ResourceLocation getEntityTexture(Entity entity) {
      return this.getEntityTexture((EntityHerobrine)entity);
   }
}
