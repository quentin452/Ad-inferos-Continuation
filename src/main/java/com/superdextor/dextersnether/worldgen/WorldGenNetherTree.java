...
public class WorldGenNetherTree extends WorldGenAbstractTree {
   ...
   void generateLeafNode(int p_76491_1_, int p_76491_2_, int p_76491_3_) {
      ...
      for(int i1 = p_76491_2_ + this.leafDistanceLimit; l < i1; ++l) {
         ...
         this.func_150529_a(p_76491_1_, l, p_76491_3_, f, (byte)1, this.hasLeaves ? NetherBlocks.nether_leaves : Blocks.air);
      }
   ...
   void generateTrunk() {
      ...
      this.func_150530_a(aint, aint1, NetherBlocks.nether_log);
      if (this.trunkSize == 2) {
         int var10002 = aint[0]++;
         var10002 = aint1[0]++;
         this.func_150530_a(aint, aint1, NetherBlocks.nether_log);
   ...
   void generateLeafNodeBases() {
      ...
      for(int[] aint = new int[]{this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i) {
         ...
         if (this.leafNodeNeedsBase(k)) {
            this.func_150530_a(aint, aint2, NetherBlocks.nether_log);
         }
      }
   ...
   boolean validTreeLocation() {
      ...
      boolean isHellBlock = block == Blocks.netherrack || block == Blocks.soul_sand || block == NetherBlocks.darkstone;
      if (!isHellBlock) {
         return false;
      } else {
